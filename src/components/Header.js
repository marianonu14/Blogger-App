...
const Header = () => {
    ...
    return ( 
        <header className="flex justify-between p-8">
            ...
            <div className={navState ? "fixed left-0 top-0 w-full h-screen bg-black/70 ease-in duration-300" : "absolute"}>
                <div className={navState ? 
                    ...
                    <div className="flex justify-between item-center mb-10">
                        <NavLink to="/" className="text-2xl" onClick={handleNav}>Blogger App</NavLink>
